...
const renderSamples = (context: any): React.ReactElement<any>[] =>
...
const HelpTab: React.SFC<WrappedFieldProps<any> & TemplateFieldProps> = ({ input, context }) => (
  <div className="pt-callout pt-intent-primary">
    ...
    <div>
      ...
      <a href="https://www.reddit.com/wiki/commenting" target="_blank">
        Reddit Formatting
      </a>
      <span> as well as </span>
      <a href="https://github.com/adammark/Markup.js/blob/master/README.md" target="_blank">
        Markup Templating
      </a>
...
const PresetButton: React.SFC<{ readonly onClick: () => void; readonly id: string }> = ({ onClick, id }) => (
  <Button onClick={onClick} intent={Intent.PRIMARY} className="pt-large">
    {id}
  </Button>
);
